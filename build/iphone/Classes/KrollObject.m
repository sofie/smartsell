 ...
 * Copyright (c) 2009-2011 by smartsell, Inc. All Rights Reserved.
...
//@interface smartsellObject : NSObject
//@end

@interface smartsellObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[smartsellObject class]])
		{
			for (NSString *key in [[(smartsellObject*)o modules] allKeys])
			{
