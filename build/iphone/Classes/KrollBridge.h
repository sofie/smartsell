...
@interface smartsellObject : KrollCoverageObject {
#else
@interface smartsellObject : KrollObject {
#endif
@private
...
extern NSString * smartsell$ModuleRequireFormat;
