...
// in simulator we redefine to format for smartsell Developer console
...
{\
	NSString * exceptionName = [@"org.smartsell." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smartsell";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsmartsellNativeItemNone = -1, 
	UIsmartsellNativeItemSpinner = -2,
	UIsmartsellNativeItemProgressBar = -3,
	
	UIsmartsellNativeItemSlider = -4,
	UIsmartsellNativeItemSwitch = -5,
	UIsmartsellNativeItemMultiButton = -6,
	UIsmartsellNativeItemSegmented = -7,
	
	UIsmartsellNativeItemTextView = -8,
	UIsmartsellNativeItemTextField = -9,
	UIsmartsellNativeItemSearchBar = -10,
	
	UIsmartsellNativeItemPicker = -11,
	UIsmartsellNativeItemDatePicker = -12,
	
	UIsmartsellNativeItemInfoLight = -13,
	UIsmartsellNativeItemInfoDark = -14,
	
	UIsmartsellNativeItemDisclosure = -15,
	
	UIsmartsellNativeItemContactAdd = -16
};
